...
export class ModelUnavailableError extends Error {
  constructor(message: string, public model: string, public modality: string) {
    super(message);
...
export class ModelLoadError extends Error {
  constructor(message: string, public model: string, public modality: string, public originalError?: Error) {
    super(message);
...
export class InferenceError extends Error {
  constructor(message: string, public modality: string, public originalError?: Error) {
    super(message);
